...
namespace framework
{
    ...
    {
        if (typeStr == "Bool")
            return SerializableValueType::Bool;
        if (typeStr == "Char")
            return SerializableValueType::Char;
        if (typeStr == "Int")
            return SerializableValueType::Int;
        if (typeStr == "Float")
            return SerializableValueType::Float;
        if (typeStr == "Double")
            return SerializableValueType::Double;
        if (typeStr == "String")
            return SerializableValueType::String;
        if (typeStr == "Vec2")
            return SerializableValueType::Vec2;
        if (typeStr == "Vec3")
            return SerializableValueType::Vec3;
        if (typeStr == "Vec4")
            return SerializableValueType::Vec4;
